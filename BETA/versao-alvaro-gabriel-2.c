...
int main() {
    ...
    // Instrucoes do jogo
    printf("Jogo Shisima - Regras de Movimentacao:\n");
    printf("1. Posicoes perifericas podem mover para:\n");
    printf("   - Posicao central (2,2)\n");
    printf("   - 2 posicoes adjacentes especificas\n");
    printf("2. Posicao central pode mover para qualquer posicao\n\n");
    printf("Jogador 1: X\nJogador 2: O\n");
